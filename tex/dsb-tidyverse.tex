...
\includegraphics[width=.18\linewidth]{$HOME/Dropbox/hsf/pic/dsb/arrange.png}

\includegraphics[width=.2\linewidth]{$HOME/Dropbox/hsf/pic/dsb/mutate.png}

\includegraphics[width=.2\linewidth]{$HOME/Dropbox/hsf/pic/dsb/select.png}

\includegraphics[width=.2\linewidth]{$HOME/Dropbox/hsf/pic/dsb/filter.png}

\includegraphics[width=.2\linewidth]{$HOME/Dropbox/hsf/pic/dsb/summarise.png}
