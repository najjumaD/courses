...
- To facilitate the organization and scheduling of all presentations, please let me know the times you are available by __October 26__. Two presentations per meeting would be ideal. If you do not let me know your preferences, I will determine the time and date. 
...
- Upload only __one .zip file__ that contains:
  1. the paper as a (a) .pdf, (b).html file 
  2. the .Rmd file
  3. the dataset (if not too large), 
  4. additional files, if necessary for me to evaluate your work.
  
  
# Evaluation 

  - *70 % -- Quality and execution of the project*
...
To knit to all formats that are mentioned in the header, type that into the console:
