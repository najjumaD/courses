...
- The paper should be written with __R Markdown__. The .Rmd file with which this document is written, can be used as a template. Information about writing and publishing with R Markdown can be found here:
...
- The outline of the paper should contain the following building blocks:
  ...
  - Further descriptions to the project, which may include, for example:
    ...
    - Challanges you had to overcome when creating the module (keep it short!).
...
1. Data Visualization with ggplot2  [@Wickham2018R: ch. 3, p. 3-36]. 
